public class Main {
    ...
    public static void task8 () {
        System.out.println("Задача 8(а)");
        var totalHours = 640;
        var averageHours = 8;
        var employees = totalHours / averageHours;
        System.out.println("Всего работников в компании " + employees + " человек");
        System.out.println("Задача 8(б)");
        employees = employees + 94;
        averageHours = totalHours / employees;
        System.out.println("Если в компании работает " + employees + " человек, то всего " + averageHours + " часов работы может быть поделено между сотрудниками");
